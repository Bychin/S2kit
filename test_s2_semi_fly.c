...
int main(int argc, char **argv) {
  ...
  */
  ...
  workspace = (double *)malloc(sizeof(double) * ((10 * (bw * bw)) + (24 * bw)));
  ...
  */
  ...
  for (i = 0; i < loops; i++) {
    ...
    *****/
    ...
    InvFST_semi_fly(rcoeffs, icoeffs, rdata, idata, bw, workspace, 1, cutoff,
                    &idctPlan, &ifftPlan);
    ...
    FST_semi_fly(rdata, idata, rresult, iresult, bw, workspace, 1, cutoff,
